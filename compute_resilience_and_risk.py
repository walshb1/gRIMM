...
results.to_csv('output/results_'+optionFee+'_'+optionPDS+'.csv',encoding="utf-8", header=True)
iah.to_csv('output/iah_'+optionFee+'_'+optionPDS+'.csv',encoding="utf-8", header=True)
