...
def get_pol_opt_str(optionFee,optionPDS,is_local_welfare,opt_social,opt_shew,opt_rshar,opt_insured):
    ...
    if opt_insured == 25:
        # Let's call this the nominal case
        opt_insured = None
    
    if (opt_social != None or opt_shew != None or opt_rshar != None or opt_insured != 25): 
        POdir += '/options'
        POstr += '_'
...
#def policy_option_exposure(opt_exposure):
